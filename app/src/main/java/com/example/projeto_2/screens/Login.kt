...
import com.example.projeto_2.repositorio.UsuariosRepositorio

@Composable
fun Login(controleDeNavegacao: NavHostController?) {

    val cr = UsuariosRepositorio(LocalContext.current)
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = {
                        Row {
                            Image(
                                painterResource(id = com.example.projeto_2.R.drawable.email),
                                contentDescription = "",
                                modifier = Modifier
                                    .width(25.dp)
                                    .height(20.dp)
                ...
                OutlinedTextField(
                    ...
                    label = {
                        Row {
                            Image(
                                painterResource(id = com.example.projeto_2.R.drawable.cadeado),
                                contentDescription = "",
                                modifier = Modifier
                                    .width(25.dp)
                                    .height(20.dp)
            ...
            Column(
                ...
                Button(
                    ...
                    Row {
                        ...
                        Image(
                            painterResource(id = com.example.projeto_2.R.drawable.seta),
                            contentDescription = "",
                            modifier = Modifier
                                .width(20.dp)
                                .height(20.dp)
...
@Composable
fun LoginPreview() {
    Login(controleDeNavegacao = null)
}